...
export function NewsPage() {
  // Hardcoded news items with fetchNewsItems logic inline
  ...
  return (
    <Box sx={{ mb: 3 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3, mt: 1 }}>
        Stay updated with the latest features and improvements to the Running Dinner platform
      </Typography>
      <Grid container direction={'column'} spacing={3}>
        {newsItems.map((newsItem) => (
          <Grid
            ...
            <NewsCard title={newsItem.title} content={newsItem.content} date={newsItem.date} />
          </Grid>
        ))}
      </Grid>
    </Box>
