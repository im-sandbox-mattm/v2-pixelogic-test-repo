> ⚠️ **Training Repository Notice**
>
> This repository is used for GitHub Copilot enablement workshops for Pixelogic.
>
> It is based on the open-source project **runningdinner**  
> by Clemens Stich, licensed under the MIT License.
>
> Original repository:  
> https://github.com/Clemens85/runningdinner
...
Currently the software is built on Github Actions and also deployed from there to AWS.
...
<a href="https://github.com/Clemens85/runningdinner-functions" target="_blank">https://github.com/Clemens85/runningdinner-functions</a> contains some AWS Lambda functions
that are also used within the app.
